...
class rPi_Communication:
    def __init__(self):
        ...
        self.HOST = '' # ip of raspi connected to the ethernet port
        self.PORT = 2022
    ...
    def start(self):
        ...
        if self.running:
            ...
            return None
        # create a thread to run the client server
        else:
            self.running = True
            self.comm_thread = threading.Thread(target=self.runComms)
    ...
    def runComms(self):
        ...
        try:
            ...
            print("Error occurred when connecting: ", error)
            ...
            try:
                ...
                if len(corners) > 0:
                    ...
                    for (marker_corner, marker_id) in zip(corners, ids):
                        ...
                        self.centerpoint = (int((top_right[0] - top_left[0])/2), int((bottom_left[1] - top_left[1])/2))
...
def run_cameras():
    ...
    if left_camera.video_capture.isOpened() and right_camera.video_capture.isOpened():
        ...
        try:
            while True:
                _, left_image, left_centerpoint = left_camera.read()
                _, right_image, right_centerpoint = right_camera.read()
